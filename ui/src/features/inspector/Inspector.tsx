 ...
 * (Recording), is acquisition healthy (Health), how much am I looking at (Channels). Technical detail
 * sits behind one disclosure.
 */
...
export function Inspector(p: InspectorProps) {
  return (
    <div className="flex flex-col gap-6 px-5 py-6">
      ...
      <p className="px-4 text-[12px] text-label-2">Space to play · ← → to skip 10 s</p>
    </div>
  );
}
