...
import type { EmptyMeta, Envelopes, FrameInfo, Meta, Session, TransportCommand, TransportState, Validation } from '../types';
...
export const api = {
   ...
   */
  async frame(q: { channels: number[]; columns: number; seconds: number }): Promise<{ info: FrameInfo; envelopes: Envelopes } | null> {
